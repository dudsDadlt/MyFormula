...
public class Eletromagnetismo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eletromagnetismo);
	...
	public void OnButtonClickedAddAndDisplay(View v) {
		...
		et1 = (EditText) findViewById(R.id.ete1);
		et2 = (EditText) findViewById(R.id.ete2);

		tvr1 = (TextView) findViewById(R.id.tvre1);
