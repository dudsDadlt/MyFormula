...
public class Ondulatoria extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ondulatoria);
	...
	public void OnButtonClickedAddAndDisplay(View v) {
		...
		et1 = (EditText) findViewById(R.id.etw1);
		et2 = (EditText) findViewById(R.id.etw2);

		tvr1 = (TextView) findViewById(R.id.tvrw1);
